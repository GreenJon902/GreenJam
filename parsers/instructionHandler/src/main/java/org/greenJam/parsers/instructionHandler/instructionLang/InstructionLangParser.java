...
import org.greenJam.api.exceptions.InstructionLangParserSyntaxError;
...
public class InstructionLangParser {
	 ...
	 * {@link org.greenJam.parsers.instructionHandler.InstructionLiteral}, bracketed expression or a
	 * "-" literal.
